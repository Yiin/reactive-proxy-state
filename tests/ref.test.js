...
describe('ref', () => {
    ...
    it('should track dependency when .value is accessed', () => {
        const r = ref(1);
        const effectMock = createMockFn(); // Explicit type
        watchEffect(() => {
    ...
    it('should not trigger effect if an object *inside* the ref is mutated (ref tracks identity)', () => {
        ...
        let innerDummy; // No initializer
        const effectMockInner = createMockFn(); // Explicit type
